...
@section('content')
    <main>
            ...
            <div class="mb-1 w-full">
                ...
                <div class="sm:flex">
                    ...
                    <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                        <button type="button" id="open-modal-button" data-modal-toggle="add-user-modal" data-model-target="add-user-modal"
                        ...
                        <table class="table-fixed min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Male</td>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">Male
                                    </td>
                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">96</td>
                                    <td class="p-4 whitespace-nowrap text-base font-normal text-gray-900">
                                        <div class="flex items-center">
                                            <div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div> Active
                                        </div>
        ...
        <!-- Add User Modal -->
        <div class="hidden overflow-x-hidden overflow-y-auto fixed top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center h-modal sm:h-full"
            id="add-user-modal" tabindex="-1" aria-hidden="true">
            <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
                <!-- Modal content -->
                <div class="bg-white rounded-lg shadow relative">
                    <!-- Modal header -->
